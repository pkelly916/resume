...
\section{Technical Skills}
      	\small \textbf{Languages}: C/C++, Rust, Python, ARM and x86 Assembly, VHDL, C\#, Java, Rust, Golang \\
        \vspace{2pt}
...
\section{Experience}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeItem{Leveraged engineering experience to perform security assessments in automotive, medical, and energy industries} 
